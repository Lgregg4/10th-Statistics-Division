...
# Conclusion 
The real mean appears to follow the distribution of the null hypothesis. Therefore, we fail to reject the null hypothesis. There does not appear to be evidence of a difference in BMI between males and females. 
...
## Ryan
wrote the team conclusion part and the recommendation parts, also wrote the data set explation parts.  Also provide us some baisc idea about the steps to test the hypothesis. tried to tell us how this work for the null hypothese and apply to the real data.
